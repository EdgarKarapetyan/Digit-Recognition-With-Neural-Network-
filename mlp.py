...
# train_file = 'data/regression/data.square.train.1000.csv'
# test_file = 'data/regression/data.square.test.1000.csv'

# train_file = 'data/regression/data.activation.train.500.csv'
# test_file = 'data/regression/data.activation.test.500.csv'
# train_file = 'data/regression/data.activation.train.1000.csv'
# test_file = 'data/regression/data.activation.test.10000.csv'
# train_file = 'data/regression/data.cube.train.1000.csv'
# test_file = 'data/regression/data.cube.test.1000.csv'
...
# train_file = 'data/classification/data.three_gauss.train.100.csv'
# test_file = 'data/classification/data.three_gauss.test.10000.csv'
